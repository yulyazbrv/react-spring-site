        ...
        <div className='first-intro'>
                <div className="container">
                    <div>
                        ...
                        <p className="first-intro-about">From configuration to security, web apps to big data—whatever the infrastructure needs of your application may be, there is a Spring Project to help you build it. Start small and use just what you need—Spring is modular by design.</p>
                    </div>
                </div>
        </div>
    )
...
const SecondIntro = (props) => {
    ...
    return (
        <div className="second-intro">
                <div>
                    <input className="search" type="search" placeholder="SEARCH" name="q" onChange={(event) => setValue(event.target.value)} />
                </div>
                ...
                <div className="container-third">
                    ...
                    <div className="container-spec-projects">	
                        <div className="child-spec-projects">
                                ...
                                <p>Provides a cohesive, versioned platform for building modern applications. It is a modular, enterprise-grade distribution that delivers a curated set of dependencies.</p>
                        </div>
                        ...
                        <div className="child-spec-projects">
                                ...
                                <p>A project to make it easier to build Spring-powered Rich Internet Applications using Adobe Flex as the front-end client.</p>
                        </div>
